  ...
  return (
    <aside className="sidebar w-full h-full">
      ...
      <nav className="nav-wrap">
        ...
        <Link href="/admin/settings/pricing" className={`ni ${isActive('/admin/settings/pricing') ? 'active' : ''}`} onClick={staticMode ? undefined : onClose}>
          <span className="ni-icon">💲</span>Web Pricing
        </Link>
        <Link href="/admin/library" className={`ni ${isActive('/admin/library') ? 'active' : ''}`} onClick={staticMode ? undefined : onClose}>
          <span className="ni-icon">📚</span>Китобхона
        </Link>
        <Link href="/admin/feedback" className={`ni ${isActive('/admin/feedback') ? 'active' : ''}`} onClick={staticMode ? undefined : onClose}>
          <span className="ni-icon">💬</span>Фикри хонандагон
        </Link>
        <Link href="/admin/push" className={`ni ${isActive('/admin/push') ? 'active' : ''}`} onClick={staticMode ? undefined : onClose}>
          <span className="ni-icon">🔔</span>Огоҳиҳо (Push)
        </Link>
