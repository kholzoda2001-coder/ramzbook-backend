 ...
 *  2. лимити рӯзона — на бештар аз 2 push дар як шабонарӯз;
...
/**
 * Ҳадди аксари push дар ЯК рӯз ба ЯК корбар — РОСТ ДУ.
 *
 * Занҷири пурраи рӯзона ҳамин ду қадам аст ва бештар аз ин лозим нест:
 *   19:00 — огоҳии НАРМ, агар имрӯз нахонда бошад;
 *   22:00 — огоҳии ҚАВӢ бо ҳисоби вақт то нимишаб, агар ҳанӯз нахонда бошад.
 * Ҳамин ки хонанда як дарс кунад, ҳарду қатъ мешаванд (сегменти
 * `studiedToday: no`). Агар нахонад — фардо аз нав ҳамон ду.
 *
 * Чаро на «фосилаи 20 соат»: он қадами дуюмро дар ҳамон рӯз мекушт.
 */
