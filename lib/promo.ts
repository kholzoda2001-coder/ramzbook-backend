...
export const defaultPromoConfig: PromoConfig = {
  // ⚠️ FAIL-CLOSED: пешфарз ХОМӮШ.
  //
  // Пештар `true` буд, ва `loadPromoConfig` ҳангоми СЕ ҳолат ба ҳамин
  // пешфарз бармегашт: сатри `promo_settings` дар база нест, JSON вайрон
  // аст, ё захира кардани админ хомӯшона ноком шуд. Дар ҳар се ҳолат
  // система бе ягон хато Premium-и 2-моҳаро ба ҲАМА мебахшид.
  //
  // Пешфарзи чунин чиз бояд «чизе намедиҳем» бошад: нокомии техникӣ
  // набояд ба бахшиши оммавӣ оварад. Барои фаъол кардан админ бояд онро
  // ВОЗЕҲАН фаъол кунад — ва он гоҳ сатр дар база вуҷуд дорад.
  enabled: false,
  days: 60,
