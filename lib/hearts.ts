 ...
 *
 * A1 аз 30/60 дақ ба 10/20 нарм карда шуд. Сабаб: дарси A1 то 32–39 машқ
 * дошт ва бо 5 дил ин ба як хато дар ҳар 6–8 машқ роҳ медод — навомӯз аз
 * модули 3 сар карда мунтазам дилаш тамом мешуд ва дарс МАҶБУРАН қатъ
 * мегардид (то 5 соат интизорӣ). Фишори пулакӣ мемонад, вале навомӯзро
 * аз курс намеронад. Дарсҳо ҳамзамон кӯтоҳ карда шуданд (ҳадди 8 калима).
 */
