...
* *The film (which) I watched...* (Филме, ки ман тамошо кардам...)`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ин духтарест, ки ба ман кумак кард.', options:['This is','the girl','who','helped','me'], answer:'This is the girl who helped me.', explanation:'This is the girl who helped me.' },
...
* He told me (that)... (Баъди tell ҳатман шахс меояд!)`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Онҳо гуфтанд, ки меоянд.', options:['They','said','they','would','come'], answer:'They said they would come.', explanation:'They said they would come.' },
