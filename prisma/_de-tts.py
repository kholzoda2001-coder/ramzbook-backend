# Тавлиди аудиои олмонӣ бо edge-tts (ройгон, бе калид, бе лимит).
#
# Овоз: de-DE-KatjaNeural — модели АСЛАН de-DE (на чандзабона, ки дар калимаҳои
# бегона лаҳҷа медиҳад). Дар санҷиш калимаи алоҳидаро дар 0.82–1.01s мегӯяд —
# тақрибан ду баробар оҳистатар аз ҳамаи овозҳои Google (0.29–0.62s), ки барои
# навомӯзи такроркунанда хеле тез буданд.
#
#   PYTHONUTF8=1 python prisma/_de-tts.py <out_dir> <items.json>
#
# items.json: [{"id": "...", "text": "Hallo"}, ...] → <out_dir>/<id>.mp3
