...
**could + феъли асосӣ** (бе to, бе -s). Манфӣ: **couldn't** (гузашта: наметавонистам).`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ту дар кӯдакӣ шино карда метавонистӣ?', options:['Could','swim','you','a','as','child'], answer:'Could you swim as a child?', explanation:'Could you swim as a child?' },
...
- **would rather** = бартарӣ додан (беҳтар мебинам): *I **would rather** stay home.* (аз рафтан беҳтар мебинам)
  Баъди would rather феъл **бе to** меояд: *I'd rather **walk** than drive.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман чой нӯшиданро аз қаҳва беҳтар мебинам.', options:['I\'d','tea','rather','than','drink','coffee'], answer:"I'd rather drink tea than coffee.", explanation:"I'd rather drink tea than coffee." },
  ...
  listening: {
    ...
    questions: [
      { question:'Why does Farhod go to the bank?', questionTranslated:'Чаро Фарҳод ба бонк меравад?', options:['To get a job','To meet a friend','To sort out money problems'], correctIndex:2, explanation:'to sort out some money problems.' },
      { question:'What does he want to do first?', questionTranslated:'Ӯ аввал чӣ кор кардан мехоҳад?', options:['Complain','Buy a car','Withdraw cash and transfer money'], correctIndex:2, explanation:'withdraw some cash and also transfer money.' },
      { question:'What does the clerk ask for?', questionTranslated:'Корманд чиро мепурсад?', options:['His passport','His phone','His car'], correctIndex:0, explanation:'Could you show me your passport?' },
      { question:'What kind of account does he open?', questionTranslated:'Ӯ кадом ҳисобро мекушояд?', options:['A savings account','No account','A business account'], correctIndex:0, explanation:'open a savings account.' },
      { question:'Why is Farhod happy?', questionTranslated:'Чаро Фарҳод хушҳол аст?', options:['He got a loan','It was free','The service was quick and staff friendly'], correctIndex:2, explanation:'the service was quick and the staff were friendly.' },
    ],
  },
  dialogue: {
  ...
  reading: {
    ...
    questions: [
      { question:'What is a good idea with money?', questionTranslated:'Бо пул фикри хуб чист?', options:['Spend everything','Save a small amount each month','Never work'], correctIndex:1, explanation:'save a small amount each month.' },
      { question:'Why shouldn\'t you borrow too much?', questionTranslated:'Чаро набояд бисёр қарз гирӣ?', options:['It is illegal','Banks are closed','Debt can grow quickly'], correctIndex:2, explanation:'debt can grow quickly.' },
      { question:'Is a cheap product always good value?', questionTranslated:'Маҳсули арзон ҳамеша арзиши хуб дорад?', options:['Yes,'Only in sales',not always','No,always'], correctIndex:3, explanation:'a cheap product is not always good value.' },
  ...
  review: {
    ...
    questions: [
      { question:'What did Malika want to buy?', questionTranslated:'Малика чӣ харидан мехост?', options:['A car','A laptop','A phone'], correctIndex:1, explanation:'wanted to buy a laptop.' },
      { question:'Why couldn\'t she buy it at first?', questionTranslated:'Чаро аввал харида натавонист?', options:['She could not afford it','It was fake','It was sold out'], correctIndex:0, explanation:'which she could not afford.' },
      { question:'What did she prefer to do?', questionTranslated:'Ӯ чӣ карданро беҳтар дид?', options:['Borrow money','Give up','Wait rather than borrow'], correctIndex:2, explanation:'She would rather wait than borrow money.' },
      { question:'What did the shop give her?', questionTranslated:'Мағоза ба ӯ чӣ дод?', options:['Nothing','A receipt and a guarantee','A free gift'], correctIndex:1, explanation:'a receipt and a two-year guarantee.' },
      { question:'What lesson did she learn?', questionTranslated:'Ӯ кадом дарсро омӯхт?', options:['Spend fast','Borrow a lot','Be patient and careful with money'], correctIndex:2, explanation:'if you are patient and careful with your budget.' },
    ],
  },
  exam: {
    ...
    questions: [
      ...
      { question:'What happens to small savings over time?', questionTranslated:'Пасандози кам бо вақт чӣ мешавад?', options:['It grows','It stays the same','It disappears'], correctIndex:0, explanation:'even a small amount grows over time.' },
      { question:'What does a smart shopper do?', questionTranslated:'Харидори доно чӣ мекунад?', options:['Never shops','Compares prices and looks for discounts','Buys everything'], correctIndex:1, explanation:'compare prices, look for discounts.' },
      { question:'Why be careful with loans?', questionTranslated:'Чаро бо қарз эҳтиёткор бошем?', options:['Banks are bad','Debt can become a heavy burden','Loans are illegal'], correctIndex:1, explanation:'debt can become a heavy burden.' },
      { question:'What is the benefit of good habits?', questionTranslated:'Фоидаи одатҳои хуб чист?', options:['Fewer money worries and more freedom','Less money','More debt'], correctIndex:0, explanation:'fewer money worries and more freedom in the future.' },
    ],
  },
};
