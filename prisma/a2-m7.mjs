...
- *She **has visited** many countries.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман ҳеҷ гоҳ ба Париж нарафтаам.', options:['I','never','have','to','been','Paris'], answer:'I have never been to Paris.', explanation:'I have never been to Paris.' },
...
- **yet** (ҳанӯз) — дар савол ва манфӣ, дар охири ҷумла: *Have you finished **yet**? / Not **yet**.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман аллакай онро дидаам.', options:['I','already','have','it','seen'], answer:'I have already seen it.', explanation:'I have already seen it.' },
