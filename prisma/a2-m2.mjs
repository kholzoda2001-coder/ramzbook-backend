...
Мисол: *My brother is taller than me. This car is more expensive than that one.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ин кӯча аз он танг­тар аст.', options:['is','This','narrower','street','than','that','one'], answer:'This street is narrower than that one.', explanation:'... narrower than ...' },
...
Мисол: *He is the tallest boy in the class. This is the best day of my life.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ӯ зирактарин донишҷӯ аст.', options:['She','the','is','cleverest','student'], answer:'She is the cleverest student.', explanation:'She + is + the cleverest + student.' },
