...
Дар ин ҷо **if** ≈ **when** (ҳар вақт). Фарқ аз шарти якум: сифрӣ = ҳамеша рост; якум = натиҷаи мушаххаси оянда (will).`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Агар шакарро гарм кунӣ, об мешавад.', options:['If','heat','you','sugar','it','melts'], answer:'If you heat sugar it melts.', explanation:'If you heat sugar, it melts.' },
...
- *I **was reading** a book when the phone **rang**.* (Ман китоб мехондам, ки телефон занг зад)`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман соати 8 телевизор тамошо мекардам.', options:['I','watching','TV','was','at 8'], answer:'I was watching TV at 8.', explanation:'I was watching TV at 8.' },
