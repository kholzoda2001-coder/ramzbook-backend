...
Мисол: *The bank is **next to** the library, **opposite** the park.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Мағоза рӯ ба рӯи бонк аст.', options:['The','is','shop','the','opposite','bank'], answer:'The shop is opposite the bank.', explanation:'... opposite the bank.' },
...
Манфӣ: **Don't** turn here.`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Дар кунҷ ба рост гард.', options:['Turn','the','right','at','corner'], answer:'Turn right at the corner.', explanation:'Turn right at the corner.' },
  ...
  listening: {
    ...
    questions: [
      { question:'What is the tourist looking for?', questionTranslated:'Сайёҳ чиро меҷӯяд?', options:['A hotel','The museum','The station'], correctIndex:1, explanation:'wants to find the museum.' },
      ...
      { question:'Where does he turn right?', questionTranslated:'Ӯ дар куҷо ба рост мегардад?', options:['At the bank','At the traffic lights','At the tower'], correctIndex:1, explanation:'At the traffic lights, turn right.' },
      { question:'What is the museum opposite?', questionTranslated:'Осорхона рӯ ба рӯи чӣ аст?', options:['A school','A big fountain','A market'], correctIndex:1, explanation:'opposite a big fountain.' },
      { question:'What does the man say about the bus?', questionTranslated:'Мард дар бораи автобус чӣ мегӯяд?', options:['Take it',walking is faster",'It is cheap',"Don't take it], correctIndex:3, explanation:"Don't take the bus." },
    ],
  },
  dialogue: {
  ...
  reading: {
    ...
    questions: [
      { question:'Where is the writer\'s flat?', questionTranslated:'Ҳуҷраи нависанда дар куҷост?', options:['Behind a factory','Near the airport','Opposite a small park'], correctIndex:2, explanation:'opposite a small park.' },
      { question:'What is next to the pharmacy?', questionTranslated:'Дар паҳлӯи дорухона чӣ ҳаст?', options:['The bank','The bakery','The library'], correctIndex:1, explanation:'The bakery is next to the pharmacy.' },
      { question:'What is in front of the building?', questionTranslated:'Дар пеши бино чӣ ҳаст?', options:['A statue','A bus stop','A bridge'], correctIndex:1, explanation:'a bus stop just in front.' },
      { question:'Why does the writer usually walk?', questionTranslated:'Чаро нависанда одатан пиёда меравад?', options:['A lot of traffic at rush hour','It is free','No buses'], correctIndex:0, explanation:'a lot of traffic, so I walk.' },
      { question:'What is the writer\'s favourite place?', questionTranslated:'Ҷои дӯстдоштаи нависанда чист?', options:['The old square with the fountain','The bus stop','The library'], correctIndex:0, explanation:'the old square with its fountain.' },
    ],
  },
  review: {
    ...
    questions: [
      { question:'Where does Bahrom want to go?', questionTranslated:'Баҳром ба куҷо рафтан мехоҳад?', options:['The museum','The airport','The stadium'], correctIndex:2, explanation:'go to the stadium.' },
      { question:'Where is the stadium?', questionTranslated:'Варзишгоҳ дар куҷост?', options:['In the square','Behind the shopping centre','Near the river'], correctIndex:1, explanation:'behind the shopping centre.' },
      { question:'Why does he take the tram?', questionTranslated:'Чаро ӯ трамвайро мегирад?', options:['It is free','He likes trams','The stadium is far'], correctIndex:2, explanation:'the stadium is far.' },
      ...
      { question:'Does Bahrom arrive on time?', questionTranslated:'Баҳром саривақт мерасад?', options:['No','Yes','He is late'], correctIndex:1, explanation:'He arrives on time.' },
    ],
  },
  exam: {
    ...
    questions: [
      { question:'Where does the walk start?', questionTranslated:'Сайр аз куҷо оғоз мешавад?', options:['The main square','The bridge','The museum'], correctIndex:0, explanation:'Start at the main square.' },
      { question:'What do you pass on the narrow street?', questionTranslated:'Дар кӯчаи танг аз назди чӣ мегузарӣ?', options:['A stadium','The bakery and bookshop','A factory'], correctIndex:1, explanation:'past the bakery and the bookshop.' },
      { question:'What is opposite the mosque?', questionTranslated:'Рӯ ба рӯи масҷид чӣ аст?', options:['A bank','A park','A historic palace'], correctIndex:2, explanation:'opposite it, a historic palace.' },
      { question:'Where is the museum?', questionTranslated:'Осорхона дар куҷост?', options:['Between the library and an old tower','Behind the mosque','On the square'], correctIndex:0, explanation:'between the library and an old tower.' },
      { question:'Why is there little traffic?', questionTranslated:'Чаро ҳаракати нақлиёт кам аст?', options:['No roads','Cars cannot enter','It is night'], correctIndex:1, explanation:'cars cannot enter.' },
    ],
  },
};
