...
**any** — дар ҷумлаи **манфӣ** ва **савол**: *I don't have any milk. Is there any bread?*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Дар яхдон каме нон ҳаст.', options:['There','some','is','bread','the','in','fridge'], answer:'There is some bread in the fridge.', explanation:'There is some bread ...' },
...
Савол: **How many** + ҳисобшаванда? *How many eggs?* | **How much** + ҳисобнашаванда? *How much sugar?*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Онҳо дӯстони зиёд доранд.', options:['They','a','have','of','lot','friends'], answer:'They have a lot of friends.', explanation:'... a lot of friends.' },
