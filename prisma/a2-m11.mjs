...
Диққат: дар манфӣ ва савол — **use to** (бе -d), зеро did аллакай гузаштаро нишон медиҳад.`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман пеш чойро дӯст намедоштам.', options:['I','use','to','like','tea',"didn't"], answer:"I didn't use to like tea.", explanation:"I didn't use to like tea." },
...
Зарф баъди феъл меояд: *She sings **beautifully**. He drives **carefully**.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Кӯдак ором хобид.', options:['The','slept','baby','quietly'], answer:'The baby slept quietly.', explanation:'The baby slept quietly.' },
