...
Зарф баъди феъл меояд: *She sings **beautifully**. He drives **carefully**.*`,
  ...
  listening: {
    ...
    questions: [
      { question:'How was the weather in the morning?', questionTranslated:'Субҳ обу ҳаво чӣ гуна буд?', options:['Beautiful and clear','Stormy','Foggy'], correctIndex:0, explanation:'the weather was beautiful ... the sky was clear.' },
      ...
      { question:'What did they hear suddenly?', questionTranslated:'Онҳо ногаҳон чиро шуниданд?', options:['Thunder','Music','A bird'], correctIndex:0, explanation:'we heard thunder.' },
      { question:'Where did they run?', questionTranslated:'Онҳо ба куҷо давиданд?', options:['To a cave','To a house','To the lake'], correctIndex:0, explanation:'ran quickly to a cave.' },
      { question:'What appeared after the storm?', questionTranslated:'Баъди тӯфон чӣ пайдо шуд?', options:['A rainbow','The moon','Snow'], correctIndex:0, explanation:'a beautiful rainbow appeared.' },
    ],
  },
  dialogue: {
    ...
    lines: [
      ...
      { speaker:'You', text:'Was the air cleaner than now?', translation:'Ҳаво аз ҳозира тозатар буд?', isUser:false },
  ...
  reading: {
    ...
    questions: [
      { question:'What happens in spring?', questionTranslated:'Дар баҳор чӣ мешавад?', options:['New leaves grow','Snow falls','Leaves turn yellow'], correctIndex:0, explanation:'New leaves grow on the branches.' },
      { question:'What do people do in summer?', questionTranslated:'Одамон дар тобистон чӣ мекунанд?', options:['Swim in lakes and rivers','Ski','Stay inside'], correctIndex:0, explanation:'swim in cool lakes and rivers.' },
      { question:'What happens to leaves in autumn?', questionTranslated:'Дар тирамоҳ бо баргҳо чӣ мешавад?', options:['They turn yellow and fall','They grow','They stay green'], correctIndex:0, explanation:'the leaves turn yellow and fall slowly.' },
      { question:'How are the roads in winter?', questionTranslated:'Роҳҳо дар зимистон чӣ гунаанд?', options:['Often icy','Muddy','Dusty'], correctIndex:0, explanation:'the roads are often icy.' },
      { question:'What does each season have?', questionTranslated:'Ҳар фасл чӣ дорад?', options:['Its own beauty','The same weather','No change'], correctIndex:0, explanation:'Each season has its own beauty.' },
    ],
  },
  review: {
    ...
    questions: [
      { question:'What didn\'t they use to have?', questionTranslated:'Онҳо чӣ надоштанд?', options:['Cars or computers','Water','Food'], correctIndex:0, explanation:"didn't use to have cars or computers." },
      { question:'What did they use to do in summer?', questionTranslated:'Онҳо дар тобистон чӣ мекарданд?', options:['Swim and climb hills','Watch TV','Work'], correctIndex:0, explanation:'swim in the river and climb the green hills.' },
      { question:'How has the river changed?', questionTranslated:'Дарё чӣ тавр тағйир ёфт?', options:['It is not as clean as before','It is bigger','It disappeared'], correctIndex:0, explanation:'the river is not as clean as before.' },
      ...
      { question:'What does the writer believe?', questionTranslated:'Нависанда ба чӣ боварӣ дорад?', options:['Nature will stay beautiful if we act wisely','Nothing can help','It is too late'], correctIndex:0, explanation:'if we act wisely, nature will stay beautiful.' },
    ],
  },
  exam: {
    ...
    questions: [
      { question:'How did nature use to be?', questionTranslated:'Табиат пеш чӣ гуна буд?', options:['Cleaner and wilder','Dirtier','The same'], correctIndex:0, explanation:'nature used to be cleaner and wilder.' },
      { question:'What fills the air today?', questionTranslated:'Имрӯз ҳаворо чӣ пур мекунад?', options:['Smoke from factories and cars','Fresh air','Rain'], correctIndex:0, explanation:'factories and cars fill the air with smoke.' },
      { question:'Why is the changing climate dangerous?', questionTranslated:'Чаро тағйири иқлим хатарнок аст?', options:['For plants, animals and people','For phones','For cars'], correctIndex:0, explanation:'dangerous for plants, animals, and people.' },
      { question:'What should we do?', questionTranslated:'Мо чӣ бояд кунем?', options:['Recycle, use less plastic, save energy','Nothing','Buy more'], correctIndex:0, explanation:'recycle our waste, use less plastic, and save energy.' },
      { question:'What does the future depend on?', questionTranslated:'Оянда аз чӣ вобаста аст?', options:['The choices we make today','Luck','The weather'], correctIndex:0, explanation:'depends on the choices we make today.' },
    ],
  },
};
