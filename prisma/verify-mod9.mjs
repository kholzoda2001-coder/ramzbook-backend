...
async function checkModule() {
  ...
  const m = await prisma.module.findFirst({ where: { order: 9, courseId: course.id }, include: { lessons: true } });
  if (!m) { console.log('Mod 9 not found'); return; }
