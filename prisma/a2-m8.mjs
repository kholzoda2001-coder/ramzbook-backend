...
Диққат: баъди should феъл бе **to** ва бе **-s** меояд (не «should to go», не «should goes»).`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ту бояд бештар машқ кунӣ.', options:['You','more','should','exercise'], answer:'You should exercise more.', explanation:'You should exercise more.' },
...
Диққат: **mustn't** (манъ) ва **don't have to** (лозим нест) маънои гуногун доранд!`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ту бояд дар бистар монӣ.', options:['You','stay','must','bed','in'], answer:'You must stay in bed.', explanation:'You must stay in bed.' },
  ...
  listening: {
    ...
    questions: [
      { question:'What are Sabina\'s symptoms?', questionTranslated:'Аломатҳои Сабина кадомҳоянд?', options:[sore throat','A broken leg','Only a cough','Headache,fever], correctIndex:3, explanation:'a headache, a high fever, and a sore throat.' },
      { question:'What illness does she have?', questionTranslated:'Ӯ кадом бемориро дорад?', options:['A cold only','The flu','Nothing'], correctIndex:1, explanation:'she has the flu.' },
      { question:'What must she not do?', questionTranslated:'Ӯ чиро набояд кунад?', options:['Rest','Go to work','Drink water'], correctIndex:1, explanation:"You mustn't go to work." },
      { question:'Does she have to take an injection?', questionTranslated:'Ба ӯ укол лозим аст?', options:['Yes',the pills are enough','Every day','No], correctIndex:3, explanation:"You don't have to take an injection." },
  ...
  reading: {
    ...
    questions: [
      { question:'What should you eat?', questionTranslated:'Ту бояд чӣ хӯрӣ?', options:['Only fast food','Fresh fruit and vegetables','A lot of sugar'], correctIndex:1, explanation:'a good diet with fresh fruit and vegetables.' },
      { question:'Why must you exercise?', questionTranslated:'Чаро ту бояд машқ кунӣ?', options:['To sleep less','To keep muscles strong','To earn money'], correctIndex:1, explanation:'exercise regularly to keep your muscles strong.' },
      { question:'How long should you sleep?', questionTranslated:'Ту бояд чанд соат хоб равӣ?', options:['About eight hours','All day','Two hours'], correctIndex:0, explanation:'sleep about eight hours a night.' },
      { question:'Why mustn\'t you forget to relax?', questionTranslated:'Чаро набояд фаромӯш кунӣ, ки ором шавӣ?', options:['Stress is bad for health','It is expensive','It is boring'], correctIndex:0, explanation:'stress is bad for your health.' },
      { question:'Do you have to run a marathon?', questionTranslated:'Ту бояд марафон давӣ?', options:[a short walk helps','No,'Every day','Yes'], correctIndex:1, explanation:"You don't have to run a marathon." },
    ],
  },
  review: {
    ...
    questions: [
      { question:'What did Karim break?', questionTranslated:'Карим чиро шикаст?', options:['His nose','His arm','His ankle'], correctIndex:2, explanation:'broke his ankle.' },
      ...
      { question:'Will he recover?', questionTranslated:'Ӯ сиҳат мешавад?', options:['No','Yes,'Never',completely'], correctIndex:1, explanation:'he will recover completely.' },
  ...
  exam: {
    ...
    questions: [
      { question:'Why is modern life often unhealthy?', questionTranslated:'Чаро ҳаёти муосир аксаран носолим аст?', options:['People walk too much',feel stressed','People sit,'People sleep too much',eat badly], correctIndex:2, explanation:'sit all day, eat badly, and feel stressed.' },
      { question:'Do you have to go to a gym?', questionTranslated:'Ту бояд ба варзишгоҳ равӣ?', options:['Yes','Never move','No,but be active daily'], correctIndex:2, explanation:"you don't have to go to a gym, but you must be active." },
      { question:'Why shouldn\'t you skip breakfast?', questionTranslated:'Чаро набояд наҳориро гузаронӣ?', options:['It gives you energy','It is fast','It is cheap'], correctIndex:0, explanation:'it gives you energy.' },
      { question:'What mustn\'t you do?', questionTranslated:'Ту чиро набояд кунӣ?', options:['Eat fresh food','Relax','Stay up too late'], correctIndex:2, explanation:"you mustn't stay up too late." },
      { question:'What is health the result of?', questionTranslated:'Саломатӣ натиҷаи чист?', options:['Money','Good daily habits','Luck'], correctIndex:1, explanation:'the result of good daily habits.' },
    ],
  },
};
