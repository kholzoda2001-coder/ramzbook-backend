...
Инчунин барои **пешбинӣ бо далел**: *Look at the clouds! It **is going to** rain.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман нақша дорам, ки хориҷ сафар кунам.', options:['I','going','am','to','abroad','travel'], answer:'I am going to travel abroad.', explanation:'I am going to travel abroad.' },
...
Савол: *Will you help me?*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман ба ту баъдтар кӯмак мекунам.', options:['I','you','will','help','later'], answer:'I will help you later.', explanation:'I will help you later.' },
