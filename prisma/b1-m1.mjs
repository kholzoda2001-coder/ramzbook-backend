...
* *I haven't printed my boarding pass **yet**.* (Ман ҳанӯз чиптамро чоп накардаам).`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман навакак чиптаи саворшавиро гирифтам.', options:['I','just','have','my boarding pass','got'], answer:'I have just got my boarding pass.', explanation:'I have just got my boarding pass.' },
...
* **while (ҳангоме ки):** Одатан пеш аз Past Continuous меояд. ***While** I was sleeping, the phone rang.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Мо хоб будем, вақте ки телефон занг зад.', options:['We','sleeping','were','when','the phone','rang'], answer:'We were sleeping when the phone rang.', explanation:'We were sleeping when the phone rang.' },
