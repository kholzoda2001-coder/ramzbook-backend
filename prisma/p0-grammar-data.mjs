...
Дар забони англисӣ фоил ҳатмист — ҷумла бе ҷонишин (ё ном) дуруст намешавад.`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Онҳо муаллим ҳастанд.', options: ['are','They','teachers'], answer: 'They are teachers.', explanation: 'Фоил → феъл → исм.' },
...
Дар англисӣ to be ҳатмист: «I am Ali», на «I Ali».`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ман муаллим ҳастам.', options: ['am','I','a','teacher'], answer: 'I am a teacher.', explanation: 'I + am + a + teacher.' },
...
A/an танҳо бо исми танҳои шумурдашаванда меоянд.`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ман себ дорам.', options: ['an','I','apple','have'], answer: 'I have an apple.', explanation: 'an apple — садонок.' },
...
Намуна: **What is your name?** — Номи ту чист?`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Саволро созед:', promptTranslated: 'Ту аз куҷоӣ?', options: ['are','Where','from','you'], answer: 'Where are you from?', explanation: 'Where + are + you + from.' },
...
Истиснолар: man → **men**, woman → **women**, child → **children**.`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ман се себ дорам.', options: ['three','I','apples','have'], answer: 'I have three apples.', explanation: 'apple → apples.' },
...
Пеш аз исм меоянд: **my brother**, **her name**.`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ин хоҳари ман аст.', options: ['my','This','sister','is'], answer: 'This is my sister.', explanation: 'my + sister.' },
...
Намуна: **I have got a sister.** — Ман як хоҳар дорам.`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ман як бародар дорам.', options: ['got','I','a','brother','have'], answer: 'I have got a brother.', explanation: 'I + have got + a + brother.' },
...
Инкор: **was not (wasn’t) / were not (weren’t)**.`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Онҳо дар хона буданд.', options: ['were','They','home','at'], answer: 'They were at home.', explanation: 'They + were + at + home.' },
...
Инкор: **do not (don’t) + феъл**. Савол: **Do you …?**`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Онҳо чой менӯшанд.', options: ['drink','They','tea'], answer: 'They drink tea.', explanation: 'They + drink + tea.' },
...
Инкор: **does not (doesn’t) + феъли асосӣ**. Савол: **Does he …?**`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ӯ дар идора кор мекунад.', options: ['works','He','an','in','office'], answer: 'He works in an office.', explanation: 'He + works + in + an + office.' },
...
Пас аз Does феъл **бе -s** меояд. Ҷавоби кӯтоҳ: **Yes, I do. / No, she doesn’t.**`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Саволро созед:', promptTranslated: 'Ту қаҳваро дӯст медорӣ?', options: ['Do','like','you','coffee'], answer: 'Do you like coffee?', explanation: 'Do + you + like + coffee.' },
...
Инкор: **cannot / can’t**. Савол: **Can you …?**`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ӯ рақс карда метавонад.', options: ['can','She','dance'], answer: 'She can dance.', explanation: 'She + can + dance.' },
...
Бо исмҳои шумориданашаванда (water, bread) ва ҷамъ (apples) кор мекунанд.`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ман каме нон дорам.', options: ['some','I','bread','have'], answer: 'I have some bread.', explanation: 'I + have + some + bread.' },
...
Намуна: **How much is this shirt?** — Ин курта чанд пул аст?`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Саволро созед:', promptTranslated: 'Ту чанд китоб дорӣ?', options: ['many','How','books','do','you','have'], answer: 'How many books do you have?', explanation: 'How many + books + do you have.' },
...
Инкор: **There isn’t / There aren’t**. Савол: **Is there …? / Are there …?**`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ду курсӣ ҳаст.', options: ['are','There','two','chairs'], answer: 'There are two chairs.', explanation: 'There are + two + chairs.' },
...
- **those** — онҳо (дур, ҷамъ): Those are birds.`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ин китоби ман аст.', options: ['is','This','book','my'], answer: 'This is my book.', explanation: 'This + is + my + book.' },
...
Намуна: **The cat is under the table.**`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Гурба зери миз аст.', options: ['is','The','cat','under','table','the'], answer: 'The cat is under the table.', explanation: 'The cat + is + under + the table.' },
...
Инкор: **Don’t** + феъл → **Don’t go!** (Нарав!).`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Дар гӯша ба чап гард.', options: ['Turn','the','left','at','corner'], answer: 'Turn left at the corner.', explanation: 'Turn + left + at + the corner.' },
...
- They **are playing**. — Онҳо бозӣ карда истодаанд.`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Ӯ куртаи сурх пӯшидааст.', options: ['is','She','a','wearing','dress','red'], answer: 'She is wearing a red dress.', explanation: 'She + is wearing + a red dress.' },
...
Намуна: **Hello, I am Ali. My name is Ali.**`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Ҷумларо созед:', promptTranslated: 'Номи ман Алӣ аст.', options: ['name','My','Ali','is'], answer: 'My name is Ali.', explanation: 'My + name + is + Ali.' },
...
Ҷавоб: **My name is …** ё **I am …**`,
    ...
    exercises: [
      ...
      { type: 'reorder', prompt: 'Саволро созед:', promptTranslated: 'Номи ту чист?', options: ['is','What','name','your'], answer: 'What is your name?', explanation: 'What + is + your + name.' },
