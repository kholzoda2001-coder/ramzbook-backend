...
* *Unless we act now, the planet will get hotter.* = *If we don't act now, the planet will get hotter.* (Агар мо ҳозир амал накунем, сайёра гармтар хоҳад шуд).`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Агар борон борад, мо дар хона мемонем.', options:['If','it','rains','we will','stay home'], answer:'If it rains we will stay home.', explanation:'If it rains we will stay home.' },
...
* *If I **were** you, I wouldn't do that.* (Агар ман ба ҷои ту мебудам, он корро намекардам).`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Агар ман ҷавобро медонистам, ба ту мегуфтам.', options:['If','I','knew the answer','I would','tell you'], answer:'If I knew the answer I would tell you.', explanation:'If I knew the answer I would tell you.' },
