...
* *This app **is used** by millions of people.* (Ин барнома аз ҷониби миллионҳо одамон истифода мешавад).`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Миллионҳо мактубҳо ҳар рӯз фиристода мешаванд.', options:['Millions of','are','sent','every day','emails'], answer:'Millions of emails are sent every day.', explanation:'Millions of emails are sent every day.' },
...
* Passive: *When **was this bridge built**?* (Ин пул кай сохта шуд?).`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ин мошинҳо дар куҷо сохта шудаанд?', options:['Where','these cars','were','made','?'], answer:'Where were these cars made?', explanation:'Where were these cars made?' },
