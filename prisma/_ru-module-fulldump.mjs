// Пурра рехтани мазмуни ЯК МОДУЛИ курси русӣ (A1) барои симулятсияи 20 донишҷӯ.
// Истифода:  node prisma/_ru-module-fulldump.mjs <order>   (пешфарз 0)
...
const M1 = mods.find((m) => Number(m.order) === ORDER);
if (!M1) throw new Error(`Модул бо order=${ORDER} ёфт нашуд`);
