...
Мисол: *I usually get up at seven. He is never late for work.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман одатан барвақт мехезам.', options:['I','get','usually','up','early'], answer:'I usually get up early.', explanation:'I + usually + get up + early.' },
...
Мисол: *I go to the gym twice a week. She calls her mother every day.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман ҳафтае се бор машқ мекунам.', options:['I','three','a','exercise','times','week'], answer:'I exercise three times a week.', explanation:'... three times a week.' },
