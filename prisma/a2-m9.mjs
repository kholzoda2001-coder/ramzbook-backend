...
Диққат: *I enjoy **to read*** ғалат аст → *I enjoy **reading**.*`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман аз аксбардорӣ лаззат мебарам.', options:['I','photography','enjoy'], answer:'I enjoy photography.', explanation:'I enjoy photography.' },
...
Феълҳои **like, love, hate** ҳам бо **-ing** ва ҳам бо **to** кор мекунанд.`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман мехоҳам ба маҳфил ҳамроҳ шавам.', options:['I','to','want','the','join','club'], answer:'I want to join the club.', explanation:'I want to join the club.' },
  ...
  listening: {
    ...
    questions: [
      { question:'What does Farhod practise every evening?', questionTranslated:'Фарҳод ҳар шом чиро машқ мекунад?', options:['The guitar','Football','The piano'], correctIndex:0, explanation:'playing the guitar and I practise every evening.' },
      { question:'What does he do at weekends?', questionTranslated:'Ӯ дар рӯзҳои истироҳат чӣ мекунад?', options:['Goes cycling','Works','Sleeps'], correctIndex:0, explanation:'like going cycling with my friends.' },
      { question:'What is he keen on?', questionTranslated:'Ӯ ба чӣ шавқманд аст?', options:['Fishing','Photography','Cooking'], correctIndex:1, explanation:'keen on photography.' },
      { question:'What does his sister prefer?', questionTranslated:'Хоҳараш чиро бартарӣ медиҳад?', options:['Skiing','Boxing','Reading and painting'], correctIndex:2, explanation:'prefers reading and painting.' },
  ...
  reading: {
    ...
    questions: [
      { question:'What does the father love?', questionTranslated:'Падар чиро дӯст медорад?', options:['Painting','Boxing','Fishing'], correctIndex:2, explanation:'The father loves fishing.' },
      { question:'What does the mother enjoy?', questionTranslated:'Модар аз чӣ лаззат мебарад?', options:['Cycling','Gardening and knitting','Skiing'], correctIndex:1, explanation:'enjoys gardening and knitting.' },
      { question:'What does Bek hope to become?', questionTranslated:'Бек умед дорад кӣ шавад?', options:['A professional player','A painter','A doctor'], correctIndex:0, explanation:'hopes to become a professional player.' },
      { question:'What does Lola want to learn?', questionTranslated:'Лола чиро омӯхтан мехоҳад?', options:['Chess','Cooking','Photography'], correctIndex:2, explanation:'wants to learn photography.' },
      { question:'What do hobbies do for the family?', questionTranslated:'Ҳобиҳо барои оила чӣ мекунанд?', options:['Waste time','Cost money','Bring them closer'], correctIndex:2, explanation:'hobbies bring the family closer.' },
    ],
  },
  review: {
    ...
    questions: [
      { question:'When did Sitora start the violin?', questionTranslated:'Ситора скрипкаро кай оғоз кард?', options:['Two years ago','As a child','Last week'], correctIndex:0, explanation:'started learning the violin two years ago.' },
      { question:'What does she hope to do one day?', questionTranslated:'Ӯ умед дорад рӯзе чӣ кунад?', options:['Buy a house','Publish a book','Win a race'], correctIndex:1, explanation:'hopes to publish a book one day.' },
      { question:'What does she prefer at the weekend?', questionTranslated:'Ӯ дар рӯзҳои истироҳат чиро бартарӣ медиҳад?', options:['Sleeping','Spending time outside','Watching TV'], correctIndex:1, explanation:'prefers spending time outside.' },
      ...
      { question:'Why does she want to try everything?', questionTranslated:'Чаро ӯ мехоҳад ҳама чизро санҷад?', options:['Life is short','She is bored','She is rich'], correctIndex:0, explanation:'Life is short.' },
    ],
  },
  exam: {
    ...
    questions: [
      { question:'How do hobbies help with stress?', questionTranslated:'Ҳобиҳо чӣ тавр бо стресс кӯмак мекунанд?', options:['They help us relax','They make us tired','They cost money'], correctIndex:0, explanation:'hobbies help us relax and forget about stress.' },
      { question:'What does learning an instrument improve?', questionTranslated:'Омӯхтани асбоби мусиқӣ чиро беҳтар мекунад?', options:['Weight','Height','Memory'], correctIndex:2, explanation:'also improves their memory.' },
      { question:'Why do hobbies help us make friends?', questionTranslated:'Чаро ҳобиҳо ба дӯстёбӣ кӯмак мекунанд?', options:['We meet people with the same interests','They are boring','They are expensive'], correctIndex:0, explanation:'we meet people who like doing the same things.' },
      { question:'Does it matter which hobby you choose?', questionTranslated:'Кадом ҳобиро интихоб кардан аҳамият дорад?', options:[quiet or active is fine',only sport','Yes,'Yes,only reading','No], correctIndex:5, explanation:'It does not matter if you prefer reading or team sports.' },
      { question:'What is the important thing?', questionTranslated:'Чизи муҳим чист?', options:['Earn money','Find something you love and keep doing it','Be the best'], correctIndex:1, explanation:'find something you love and to keep doing it.' },
    ],
  },
};
