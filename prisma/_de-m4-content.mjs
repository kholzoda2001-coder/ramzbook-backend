...
export const VOCAB = [
  {
    ...
    words: [
      { word: 'rot', existing: true, existing: true },
      { word: 'blau', existing: true, existing: true },
      { word: 'grün', existing: true, existing: true },
      { word: 'gelb', existing: true, existing: true },
      { word: 'weiß', existing: true, existing: true },
      { word: 'schwarz', existing: true, existing: true },
    ],
  },
  {
    title: 'Weitere Farben', titleTranslated: 'Рангҳои дигар', emoji: '🌈',
    words: [
      { word: 'orange', existing: true, existing: true },
      { word: 'lila', existing: true, existing: true },
      { word: 'rosa', existing: true, existing: true },
      { word: 'braun', existing: true, existing: true },
      { word: 'grau', existing: true, translation: 'хокистарӣ', emoji: '⬜', ipa: '/ɡʁaʊ̯/',
  ...
  },
  {
    ...
    words: [
      { word: 'groß', existing: true, existing: true },
      { word: 'klein', existing: true, existing: true },
      { word: 'dick', existing: true, translation: 'ғафс', emoji: '🧱', ipa: '/dɪk/',
        example: 'Das Buch ist sehr dick.', exampleTrans: 'Китоб хеле ғафс аст.' },
      { word: 'dünn', existing: true, translation: 'борик', emoji: '📄', ipa: '/dʏn/',
  ...
  },
  {
    ...
    words: [
      { word: 'gut', existing: true, existing: true },
      { word: 'schlecht', existing: true, existing: true },
      { word: 'schön', existing: true, existing: true },
      { word: 'neu', existing: true, existing: true },
      { word: 'alt', existing: true, existing: true },
    ],
  },
  {
    title: 'Warm oder kalt?', titleTranslated: 'Гарм ё хунук?', emoji: '🌡️',
    words: [
      { word: 'warm', existing: true, existing: true },
      { word: 'kalt', existing: true, translation: 'хунук', emoji: '❄️', ipa: '/kalt/',
        example: 'Das Wasser ist kalt.', exampleTrans: 'Об хунук аст.' },
      { word: 'heiß', existing: true, translation: 'доғ', emoji: '🔥', ipa: '/haɪ̯s/',
        example: 'Der Tee ist zu heiß.', exampleTrans: 'Чой аз ҳад доғ аст.' },
      { word: 'sauber', existing: true, translation: 'тоза', emoji: '✨', ipa: '/ˈzaʊ̯bɐ/',
        example: 'Mein Zimmer ist sauber.', exampleTrans: 'Ҳуҷраи ман тоза аст.' },
      { word: 'schmutzig', existing: true, translation: 'ифлос', emoji: '🧼', ipa: '/ˈʃmʊt͡sɪç/',
  ...
  },
  {
    ...
    words: [
      { word: 'das Buch', existing: true, translation: 'китоб', emoji: '📕', ipa: '/das buːx/',
        example: 'Das Buch ist alt.', exampleTrans: 'Китоб кӯҳна аст.' },
          { word: 'voll', existing: true, translation: 'пур', emoji: '🫙', ipa: '/fɔl/',
        example: 'Das Glas ist voll.', exampleTrans: 'Истакон пур аст.' },
      { word: 'leer', existing: true, translation: 'холӣ', emoji: '🗑️', ipa: '/leːɐ̯/',
        example: 'Die Tasche ist leer.', exampleTrans: 'Сумка холӣ аст.' },
      { word: 'rund', existing: true, translation: 'мудаввар', emoji: '⭕', ipa: '/ʁʊnt/',
        example: 'Der Tisch ist rund.', exampleTrans: 'Миз мудаввар аст.' },
      { word: 'weich', existing: true, translation: 'нарм', emoji: '🧸', ipa: '/vaɪ̯ç/',
        example: 'Das Bett ist weich.', exampleTrans: 'Кат нарм аст.' },
      { word: 'hart', existing: true, translation: 'сахт', emoji: '🧱', ipa: '/haʁt/',
        example: 'Der Stuhl ist hart.', exampleTrans: 'Курсӣ сахт аст.' },
],
  },
  {
    title: 'Welche Farbe?', titleTranslated: 'Кадом ранг?', emoji: '❓',
    words: [
      { word: 'die Farbe', existing: true, translation: 'ранг', emoji: '🎨', ipa: '/diː ˈfaʁbə/',
        example: 'Blau ist meine Farbe.', exampleTrans: 'Кабуд ранги ман аст.' },
      { word: 'Welche Farbe hat das', existing: true, translation: 'Ин кадом ранг дорад?', emoji: '❓',
        ipa: '/ˈvɛlçə ˈfaʁbə hat das/',
        example: 'Welche Farbe hat das Auto?', exampleTrans: 'Мошин кадом ранг дорад?' },
          { word: 'bunt', existing: true, translation: 'рангоранг', emoji: '🌈', ipa: '/bʊnt/',
        example: 'Das Bild ist bunt.', exampleTrans: 'Расм рангоранг аст.' },
      { word: 'die Lieblingsfarbe', existing: true, translation: 'ранги дӯстдошта', emoji: '💖', ipa: '/diː ˈliːplɪŋsˌfaʁbə/',
        example: 'Meine Lieblingsfarbe ist blau.', exampleTrans: 'Ранги дӯстдоштаи ман кабуд аст.' },
      { word: 'golden', existing: true, translation: 'тиллоӣ', emoji: '🥇', ipa: '/ˈɡɔldən/',
        example: 'Die Uhr ist golden.', exampleTrans: 'Соат тиллоӣ аст.' },
      { word: 'silbern', existing: true, translation: 'нуқрагин', emoji: '🥈', ipa: '/ˈzɪlbɐn/',
        example: 'Der Löffel ist silbern.', exampleTrans: 'Қошуқ нуқрагин аст.' },
],
  },
];
...
export const WRITING = {
  ...
  copyOf: ['rot', 'blau', 'grün', 'grau', 'kalt', 'bunt', 'die Farbe', 'golden'],
};
