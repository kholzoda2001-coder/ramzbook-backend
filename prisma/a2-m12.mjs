...
Тартибро иваз кардан мумкин: *We will stay home **if it rains**.* (бе вергул)`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Агар машқ кунӣ, беҳтар мешавӣ.', options:['If','practise','you','will','you','improve'], answer:'If you practise you will improve.', explanation:'If you practise, you will improve.' },
...
Диққат: **because** + сабаб, **so** + натиҷа — онҳо баръакси ҳамдигаранд.`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман хурсанд будам, зеро ту омадӣ.', options:['I','happy','was','because','came','you'], answer:'I was happy because you came.', explanation:'I was happy because you came.' },
