...
const M = {
  ...
  emoji: '🌟', color: '#3B82F6',
  vocab: [
    { title: 'Lesson 1: Emotions', tt: 'Дарси 1: Эҳсосот', emoji: '😊', words: [
      W('Tense','/tens/','тенс','Асабӣ / шахшуда','😬','I feel tense before exams.','Ман пеш аз имтиҳон асабӣ мешавам.','adjective'),
      W('Content','/kənˈtent/','контент','Қаноатманд / розӣ','🙂','She feels content with her life.','Ӯ аз ҳаёташ қаноатманд аст.','adjective'),
      W('Jealous','/ˈdʒeləs/','ҷелес','Ҳасадхӯр','😒','Don\'t be jealous of others.','Ба дигарон ҳасад набар.','adjective'),
      W('Eager','/ˈiːɡə/','игер','Иштиёқманд / бесаброна','🤗','He is eager to learn.','Ӯ ба омӯхтан иштиёқманд аст.','adjective'),
      W('Grateful','/ˈɡreɪtfʊl/','грейтфул','Миннатдор','🙏','I am grateful for your help.','Ман барои кӯмакат миннатдорам.','adjective'),
      W('Homesick','/ˈhəʊmsɪk/','ҳоумсик','Дилтанги хона','😔','She felt homesick abroad.','Ӯ дар хориҷ дилтанги хона шуд.','adjective'),
      W('Confused','/kənˈfjuːzd/','конфюзд','Саросема / ошуфта','😕','I am confused about the rules.','Ман дар бораи қоидаҳо саросемаам.','adjective'),
      W('Relieved','/rɪˈliːvd/','риливд','Осуда / сабукдил','😅','I was relieved after the test.','Баъди имтиҳон ман сабукдил шудам.','adjective'),
      W('Guilty','/ˈɡɪlti/','гилти','Гунаҳкор','😔','He felt guilty about the lie.','Ӯ аз дурӯғ худро гунаҳкор ҳис кард.','adjective'),
      W('Uneasy','/ʌnˈiːzi/','анизи','Ноором / бетоқат','😟','I feel uneasy about the trip.','Ман дар бораи сафар ноором ҳастам.','adjective'),
    ]},
    { title: 'Lesson 2: Strong Feelings', tt: 'Дарси 2: Ҳиссиёти қавӣ', emoji: '😲', words: [
      W('Delighted','/dɪˈlaɪtɪd/','дилайтид','Хеле шод','😄','We were delighted with the news.','Мо аз хабар хеле шод шудем.','adjective'),
      W('Furious','/ˈfjʊəriəs/','фюриес','Хеле хашмгин','😡','He was furious about the delay.','Ӯ аз таъхир хеле хашмгин буд.','adjective'),
      W('Terrified','/ˈterɪfaɪd/','терифайд','Сахт тарсида','😱','She was terrified of the dark.','Ӯ аз торикӣ сахт метарсид.','adjective'),
      W('Amazed','/əˈmeɪzd/','амейзд','Ҳайрон','🤩','I was amazed by the view.','Ман аз манзара ҳайрон шудам.','adjective'),
      W('Disappointed','/ˌdɪsəˈpɔɪntɪd/','дисапойнтид','Ноумед','😞','He was disappointed with his score.','Ӯ аз холаш ноумед шуд.','adjective'),
      W('Upset','/ʌpˈset/','апсет','Ранҷида / хафа','😢','She was upset after the argument.','Ӯ баъди баҳс хафа буд.','adjective'),
      W('Frightened','/ˈfraɪtnd/','фрайтенд','Тарсида','😨','The child was frightened by the dog.','Кӯдак аз саг тарсид.','adjective'),
      W('Stressed','/strest/','стрест','Дар фишор / асабӣ','😫','I feel stressed before a deadline.','Ман пеш аз мӯҳлат асабӣ мешавам.','adjective'),
      W('Cheerful','/ˈtʃɪəfʊl/','чирфул','Хушрӯҳия / шодмон','😁','She has a cheerful smile.','Ӯ табассуми шодмон дорад.','adjective'),
...
Диққат: **because** + сабаб, **so** + натиҷа — онҳо баръакси ҳамдигаранд.`,
  ...
  listening: {
    ...
    questions: [
      { question:'What is Shirin\'s dream?', questionTranslated:'Орзуи Ширин чист?', options:['To become a doctor','To travel','To be rich'], correctIndex:0, explanation:'I want to become a doctor.' },
      { question:'Why does she want this job?', questionTranslated:'Чаро ӯ ин корро мехоҳад?', options:['She loves helping people','It is easy','For money'], correctIndex:0, explanation:'because I love helping people.' },
      { question:'What does her teacher say?', questionTranslated:'Муаллимаш чӣ мегӯяд?', options:['If she works hard, she will achieve her goal','She should give up','It is impossible'], correctIndex:0, explanation:'if I work hard, I will achieve my goal.' },
      ...
      { question:'When do dreams come true?', questionTranslated:'Орзуҳо кай амалӣ мешаванд?', options:['If we never give up','Only with luck','Never'], correctIndex:0, explanation:'dreams come true if we never give up.' },
    ],
  },
  dialogue: {
  ...
  reading: {
    ...
    questions: [
      { question:'What was Anvar\'s dream?', questionTranslated:'Орзуи Анвар чӣ буд?', options:['To become an artist','To be a doctor','To travel'], correctIndex:0, explanation:'dreamed of becoming an artist.' },
      { question:'Why couldn\'t he buy expensive paints?', questionTranslated:'Чаро ӯ рангҳои гаронро харида наметавонист?', options:['His family was poor','He was lazy','No shops'], correctIndex:0, explanation:'His family was poor.' },
      { question:'What did he use to draw with?', questionTranslated:'Ӯ бо чӣ расм мекашид?', options:['Simple pencils','Expensive paints','A computer'], correctIndex:0, explanation:'draw with simple pencils.' },
      { question:'What happened at the competition?', questionTranslated:'Дар озмун чӣ шуд?', options:['He won first prize','He lost','He did not go'], correctIndex:0, explanation:'he won first prize!' },
      { question:'What is his advice?', questionTranslated:'Маслиҳати ӯ чист?', options:['Believe in your dream and work hard','Give up','Wait for luck'], correctIndex:0, explanation:'If you believe in your dream and work hard, you will achieve it.' },
    ],
  },
  review: {
    ...
    questions: [
      { question:'What should we do when we feel nervous or upset?', questionTranslated:'Вақте ба ташвиш ё хафа мешавем, чӣ кунем?', options:['Stay positive and never lose hope','Give up','Stay in bed'], correctIndex:0, explanation:'stay positive and never lose hope.' },
      { question:'What does success need?', questionTranslated:'Муваффақият чӣ мехоҳад?', options:['Patience, courage, and strong will','Only money','Only luck'], correctIndex:0, explanation:'patience, courage, and a strong will.' },
      { question:'What does every mistake do?', questionTranslated:'Ҳар хато чӣ мекунад?', options:['Teaches us something','Ends everything','Means nothing'], correctIndex:0, explanation:'every mistake teaches us something.' },
      { question:'Who helps us stay strong?', questionTranslated:'Кӣ ба мо кӯмак мекунад қавӣ бимонем?', options:['Good friends and a kind family','No one','Only teachers'], correctIndex:0, explanation:'Good friends and a kind family.' },
      { question:'What will happen if we believe in ourselves?', questionTranslated:'Агар ба худамон бовар кунем, чӣ мешавад?', options:['We will find a way','Nothing','We will fail'], correctIndex:0, explanation:'If we believe in ourselves, we will find a way.' },
    ],
  },
  exam: {
    ...
    questions: [
      { question:'What is the difference between people who succeed and others?', questionTranslated:'Фарқи одамони муваффақ аз дигарон чист?', options:['Attitude','Only money','Only talent'], correctIndex:0, explanation:'the difference is often not talent or money, but attitude.' },
      ...
      { question:'Why are they patient?', questionTranslated:'Чаро онҳо босабранд?', options:['Big dreams take time','They are lazy','They have no plan'], correctIndex:0, explanation:'big dreams take time.' },
      { question:'What do they do when they fail?', questionTranslated:'Вақте ноком мешаванд, чӣ мекунанд?', options:['Learn and try again','Give up','Blame others'], correctIndex:0, explanation:'they learn and try again.' },
      { question:'What is the final message?', questionTranslated:'Паёми ниҳоӣ чист?', options:['With a dream and courage, you will make it real','Dreams are useless','Only luck matters'], correctIndex:0, explanation:'if you have a dream and the courage to follow it, one day you will make it real.' },
    ],
  },
};
