// Аудити пурраи ҳамаи мазмуни туркӣ (tr → tg) — аз рӯи он чи ХОНАНДА мебинад.
// Танҳо мехонад, чизе намеқавад.
//
//   node prisma/_tr-audit.mjs
...
const DE = 'cmqdgus870000c7nfz5z16xbx';
...
if (letters.length !== 29) P('алифбо', `${letters.length} ҳарф (бояд 29 — алифбои туркӣ)`);
