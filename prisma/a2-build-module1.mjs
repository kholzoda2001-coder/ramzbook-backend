...
Мисол: *I worked yesterday. She lived in Khujand.*`,
    ...
    exercises: [
      ...
      { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман дирӯз кор кардам.', options:['worked','I','yesterday'], answer:'I worked yesterday.', explanation:'I + worked + yesterday.' },
...
*didn't went ❌ → didn't go ✅ · Did you played? ❌ → Did you play? ✅*`,
    ...
    exercises: [
      ...
      { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ту филмро дидӣ?', options:['Did','see','you','the','film'], answer:'Did you see the film?', explanation:'Did + you + see + the + film?' },
...
- **tell** → told (гуфтан)`,
    ...
    exercises: [
      ...
      { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман дирӯз ба мактаб рафтам.', options:['I','went','to','school','yesterday'], answer:'I went to school yesterday.', explanation:'I went to school yesterday.' },
