...
**Фарқ бо Present Simple:** Present Simple = одат/ҳамеша (*I use my phone every day*), Present Continuous = ҳозир (*I am using it now*).`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Ман ҳоло мусиқӣ гӯш карда истодаам.', options:['I','listening','am','to','music','now'], answer:'I am listening to music now.', explanation:'I am listening to music now.' },
...
Баъзеашон ҷудошаванда: *Turn **the TV** on* ё *Turn on **the TV*** — ҳарду дуруст.`,
      ...
      exercises: [
        ...
        { type:'reorder', prompt:'Ҷумларо созед:', promptTranslated:'Заряддиҳандаро васл кун, лутфан.', options:['Plug','the','in','charger','please'], answer:'Plug in the charger please.', explanation:'Plug in the charger.' },
  ...
  listening: {
    ...
    questions: [
      { question:'What is Aziza trying to do?', questionTranslated:'Азиза чӣ кор кардан мехоҳад?', options:['Play a game','Buy a laptop','Join an online class'], correctIndex:2, explanation:'trying to join an online class.' },
      { question:'What is the first problem?', questionTranslated:'Мушкили аввал чист?', options:['No screen','The wifi is very slow','No sound'], correctIndex:1, explanation:'the wifi is very slow.' },
      { question:'What does her brother say to do first?', questionTranslated:'Бародараш мегӯяд аввал чӣ кунад?', options:['Call the teacher','Turn it off and on again','Buy a new one'], correctIndex:1, explanation:'turn off the laptop and turn it on again.' },
      { question:'Why does it not connect?', questionTranslated:'Чаро пайваст намешавад?', options:['The battery is low','No wifi','No password'], correctIndex:0, explanation:'Your battery is low.' },
  ...
  reading: {
    ...
    questions: [
      { question:'What are most people using their phones for?', questionTranslated:'Аксари одамон телефонҳоро барои чӣ истифода мебаранд?', options:['Only calls','Only games','Almost everything'], correctIndex:2, explanation:'using their phones for almost everything.' },
      { question:'A smartphone is like what?', questionTranslated:'Смартфон ба чӣ монанд аст?', options:['A small computer','A book','A television'], correctIndex:0, explanation:'like a small computer in your pocket.' },
      { question:'What is one problem?', questionTranslated:'Як мушкил чист?', options:['No apps','No wifi','Too much time online'], correctIndex:2, explanation:'spend too much time online.' },
      { question:'What is bad for our eyes and sleep?', questionTranslated:'Чӣ барои чашм ва хоб бад аст?', options:['Reading books','Too much screen time','Walking'], correctIndex:1, explanation:'too much screen time is bad.' },
      { question:'How must we use technology?', questionTranslated:'Мо технологияро чӣ тавр истифода барем?', options:['Never','All day','Carefully'], correctIndex:2, explanation:'we must use it carefully.' },
    ],
  },
  review: {
    ...
    questions: [
      { question:'What is Bahodur\'s job?', questionTranslated:'Кори Баҳодур чист?', options:['A driver','A web designer','A teacher'], correctIndex:1, explanation:'works from home as a web designer.' },
      ...
      { question:'What is his rule after six o\'clock?', questionTranslated:'Қоидаи ӯ баъди соати шаш чист?', options:['Buy a phone','Work more','Turn off the computer'], correctIndex:2, explanation:'he turns off his computer.' },
      { question:'Does he go online in the evening?', questionTranslated:'Ӯ шом ба интернет мебарояд?', options:['No,'Only a little',always','Yes,not at all'], correctIndex:0, explanation:'he does not go online at all.' },
  ...
  exam: {
    ...
    questions: [
      { question:'What are students using computers and phones for?', questionTranslated:'Донишҷӯён компютеру телефонҳоро барои чӣ истифода мебаранд?', options:['Study,'Only games',have fun',talk to friends,'Only calls'], correctIndex:0, explanation:'to study, to talk to friends, and to have fun.' },
      { question:'What can you do on the internet?', questionTranslated:'Дар интернет чӣ кор карда метавонӣ?', options:['Nothing useful','Look up information and download books','Only chat'], correctIndex:1, explanation:'look up any information, download books.' },
      { question:'What shouldn\'t we share with strangers?', questionTranslated:'Мо бо бегонаҳо чиро набояд мубодила кунем?', options:['Private information','Our hobbies','Photos of nature'], correctIndex:0, explanation:"shouldn't share private information with strangers." },
      { question:'What is important to do sometimes?', questionTranslated:'Баъзан чӣ кор кардан муҳим аст?', options:['Stay online','Buy new phones','Turn off our devices'], correctIndex:2, explanation:'turn off our devices sometimes.' },
      { question:'What should technology do?', questionTranslated:'Технология бояд чӣ кунад?', options:['Waste our time','Control our lives','Help us live better'], correctIndex:2, explanation:'help us live better, not take over our lives.' },
    ],
  },
};
