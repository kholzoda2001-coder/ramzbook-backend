...
CONTENT.grammar.push(
  ...
  {
    key: 'vowel_reduction', emoji: '🗣️', title: 'Произношение: редукция гласных', titleTranslated: 'Талаффуз: редуксияи садонокҳо',
    explanation: 'Дар русӣ садоноки **бе зада (безударный)** дигар хел талаффуз мешавад — ин «редукция» ном дорад. Ин қоидаи асосии талаффузи русӣ аст:\n\n- **О бе зада → /а/**: молоко → /малако/, хорошо → /харашо/, окно → /акно/\n- **Е/Я бе зада → /и/**: язык → /йизык/, весна → /висна/\n- Танҳо садоноки **бо зада (ударный)** пурра талаффуз мешавад.\n\nМисол: «хорош**о**» — зада дар охир аст, пас ду «о»-и аввал ҳамчун «а» хонда мешавад: /хА-рА-шО/.',
    examples: [
      { sentence: 'Молоко — /малако/', translation: 'Шир (се «о», аммо ду «а» хонда мешавад)', highlight: 'Молоко' },
      { sentence: 'Хорошо — /харашо/', translation: 'Хуб', highlight: 'Хорошо' },
      { sentence: 'Вода — /вада/', translation: 'Об', highlight: 'Вода' },
    ],
    rules: [
      { pattern: 'О бе зада → /а/', note: 'окно → /акно/, она → /ана/.' },
      { pattern: 'Е/Я бе зада → /и/', note: 'река → /рика/, пятак → /питак/.' },
      { pattern: 'Зада муҳим аст', note: 'Танҳо садоноки бо зада пурра хонда мешавад.' },
    ],
    exercises: [
      { type: 'choose', prompt: 'Калимаи «молоко» чӣ хел хонда мешавад?', promptTranslated: 'Шир — талаффуз?', answer: '/малако/', options: ['/малако/', '/молоко/', '/мулуку/'], explanation: 'О бе зада → /а/.' },
      { type: 'choose', prompt: 'Калимаи «вода» чӣ хел хонда мешавад?', promptTranslated: 'Об — талаффуз?', answer: '/вада/', options: ['/вода/', '/вада/', '/вуда/'], explanation: 'О бе зада → /а/, зада дар «а»-и охир.' },
    ],
  },
  {
    key: 'verb_conj2', emoji: '🔂', title: 'Спряжение глаголов (II тип)', titleTranslated: 'Феълҳои ҳозира (II тип — говорить)',
    explanation: 'Феълҳое, ки ба **-ить** тамом мешаванд, тибқи **II тип** тасриф меёбанд. Феъли **говорить** (гап задан):\n\n- **я говорю** — ман гап мезанам\n- **ты говоришь** — ту гап мезанӣ\n- **он/она говорит** — ӯ гап мезанад\n- **мы говорим** — мо гап мезанем\n- **вы говорите** — шумо гап мезанед\n- **они говорят** — онҳо гап мезананд\n\nФарқ аз I тип: дар охир **-и-** меояд (говор**и**шь), на **-е-**. Ҳамчунин: любить, учить, смотреть.',
    examples: [
      { sentence: 'Я говорю по-русски.', translation: 'Ман ба русӣ гап мезанам.', highlight: 'говорю' },
      { sentence: 'Ты говоришь по-таджикски?', translation: 'Ту ба тоҷикӣ гап мезанӣ?', highlight: 'говоришь' },
      { sentence: 'Они говорят громко.', translation: 'Онҳо баланд гап мезананд.', highlight: 'говорят' },
    ],
    rules: [
      { pattern: 'я → -ю / -у', note: 'я говорю, я учу.' },
      { pattern: 'ты → -ишь', note: 'ты говоришь (на -ешь!).' },
      { pattern: 'они → -ят / -ат', note: 'они говорят, они учат.' },
    ],
    exercises: [
      { type: 'choose', prompt: 'Ты ___ по-русски? (говорить)', promptTranslated: 'Ту ба русӣ гап мезанӣ?', answer: 'говоришь', options: ['говорешь', 'говоришь', 'говорёшь'], explanation: 'II тип → -ишь.' },
      { type: 'choose', prompt: 'Они ___ громко. (говорить)', promptTranslated: 'Онҳо баланд гап мезананд.', answer: 'говорят', options: ['говорют', 'говорят', 'говорат'], explanation: 'II тип, они → -ят.' },
    ],
  },
  {
    key: 'want', emoji: '🙏', title: 'Глагол «хотеть» (хочу)', titleTranslated: 'Феъли «хотеть» — мехоҳам',
    explanation: 'Феъли **хотеть** (хостан) феъли беқоида аст — бояд аз ёд кард:\n\n- **я хочу** — ман мехоҳам\n- **ты хочешь** — ту мехоҳӣ\n- **он/она хочет** — ӯ мехоҳад\n- **мы хотим** — мо мехоҳем\n- **вы хотите** — шумо мехоҳед\n- **они хотят** — онҳо мехоҳанд\n\nБаъди «хочу» исм дар **винительный падеж** ё феъл меояд:\n- Я хочу ча**й**. — Ман чой мехоҳам.\n- Я хочу **есть**. — Ман хӯрдан мехоҳам.',
    examples: [
      { sentence: 'Я хочу чай.', translation: 'Ман чой мехоҳам.', highlight: 'хочу' },
      { sentence: 'Ты хочешь есть?', translation: 'Ту хӯрдан мехоҳӣ?', highlight: 'хочешь' },
      { sentence: 'Она хочет спать.', translation: 'Ӯ хобидан мехоҳад.', highlight: 'хочет' },
    ],
    rules: [
      { pattern: 'я хочу / ты хочешь / он хочет', note: 'Шаклҳои танҳо.' },
      { pattern: 'мы хотим / вы хотите / они хотят', note: 'Шаклҳои ҷамъ.' },
    ],
    exercises: [
      { type: 'choose', prompt: 'Я ___ чай. (хотеть)', promptTranslated: 'Ман чой мехоҳам.', answer: 'хочу', options: ['хочу', 'хочешь', 'хочет'], explanation: 'Бо я → хочу.' },
      { type: 'choose', prompt: 'Ты ___ есть? (хотеть)', promptTranslated: 'Ту хӯрдан мехоҳӣ?', answer: 'хочешь', options: ['хочу', 'хочешь', 'хотим'], explanation: 'Бо ты → хочешь.' },
    ],
  },
  {
    key: 'accusative', emoji: '🎯', title: 'Винительный падеж (что? кого?)', titleTranslated: 'Падежи винительный (чиро? киро?)',
    explanation: 'Вақте феъл ба ашё таъсир мекунад (хондан, дидан, дӯст доштан, хостан), исм ба **винительный падеж** мегузарад. Савол: **что? (чиро?)** ё **кого? (киро?)**:\n\n- Исми **мардонаи беҷон** ва **миёна** тағйир намеёбад: Я читаю журнал, письмо.\n- Исми **занона (-а → -у)**: книг**а** → Я читаю книг**у**; мам**а** → Я люблю мам**у**.\n- Исми **ҷондор-мардона (-а → -у/-я)**: брат → Я вижу брат**а**.\n\nДар A1 муҳимтаринаш: **-а → -у** барои исми занона.',
    examples: [
      { sentence: 'Я читаю книгу.', translation: 'Ман китоб мехонам. (книга → книгу)', highlight: 'книгу' },
      { sentence: 'Я люблю маму.', translation: 'Ман модарро дӯст медорам. (мама → маму)', highlight: 'маму' },
      { sentence: 'Я хочу воду.', translation: 'Ман об мехоҳам. (вода → воду)', highlight: 'воду' },
    ],
    rules: [
      { pattern: 'Занона: -а → -у', note: 'книга → книгу, вода → воду, музыка → музыку.' },
      { pattern: 'Занона: -я → -ю', note: 'песня → песню.' },
      { pattern: 'Мардонаи беҷон + миёна → тағйир намеёбад', note: 'журнал, окно — ҳамон.' },
    ],
    exercises: [
      { type: 'choose', prompt: 'Я читаю ___. (книга)', promptTranslated: 'Ман китоб мехонам.', answer: 'книгу', options: ['книга', 'книгу', 'книге'], explanation: 'Винительный: -а → -у.' },
      { type: 'choose', prompt: 'Я люблю ___. (музыка)', promptTranslated: 'Ман мусиқӣ дӯст медорам.', answer: 'музыку', options: ['музыка', 'музыку', 'музыки'], explanation: 'Винительный: -а → -у.' },
      { type: 'choose', prompt: 'Я хочу ___. (вода)', promptTranslated: 'Ман об мехоҳам.', answer: 'воду', options: ['вода', 'воду', 'воды'], explanation: 'Винительный: -а → -у.' },
    ],
  },
  {
    key: 'past_tense', emoji: '⏮️', title: 'Прошедшее время', titleTranslated: 'Замони гузашта (буд / кард)',
    explanation: 'Барои замони гузашта дар русӣ ба асоси феъл **-л** илова мешавад ва тибқи **ҷинс ва шумора** тағйир меёбад:\n\n- **Мард**: -л → Он чита**л**, был, работа**л**\n- **Зан**: -ла → Она чита**ла**, была, работа**ла**\n- **Миёна**: -ло → Оно бы**ло**\n- **Ҷамъ**: -ли → Они чита**ли**, были\n\nФеъли **быть** (будан) дар гузашта: был / была / было / были.\n- Я был дома. — Ман дар хона будам. (мард)\n- Я была дома. — Ман дар хона будам. (зан)',
    examples: [
      { sentence: 'Он читал книгу.', translation: 'Ӯ (мард) китоб мехонд.', highlight: 'читал' },
      { sentence: 'Она читала книгу.', translation: 'Ӯ (зан) китоб мехонд.', highlight: 'читала' },
      { sentence: 'Вчера я был дома.', translation: 'Дирӯз ман (мард) дар хона будам.', highlight: 'был' },
      { sentence: 'Они были в школе.', translation: 'Онҳо дар мактаб буданд.', highlight: 'были' },
    ],
    rules: [
      { pattern: 'Мард → -л', note: 'работал, читал, был.' },
      { pattern: 'Зан → -ла', note: 'работала, читала, была.' },
      { pattern: 'Ҷамъ → -ли', note: 'работали, читали, были.' },
    ],
    exercises: [
      { type: 'choose', prompt: 'Вчера она ___ дома. (быть)', promptTranslated: 'Дирӯз ӯ (зан) дар хона буд.', answer: 'была', options: ['был', 'была', 'были'], explanation: 'Зан → была.' },
      { type: 'choose', prompt: 'Он ___ книгу. (читать)', promptTranslated: 'Ӯ (мард) китоб мехонд.', answer: 'читал', options: ['читал', 'читала', 'читали'], explanation: 'Мард → читал.' },
      { type: 'choose', prompt: 'Они ___ в школе. (быть)', promptTranslated: 'Онҳо дар мактаб буданд.', answer: 'были', options: ['был', 'была', 'были'], explanation: 'Ҷамъ → были.' },
    ],
  },
);
...
CONTENT.modules.push(
  {
    ...
    lessons: [
      ...
      { skillType: 'grammar', grammarKey: 'vowel_reduction', title: 'Pronunciation: vowel reduction', titleTranslated: 'Талаффуз: редуксияи садонокҳо', emoji: '🗣️' },
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        words: [
          { word: 'Одиннадцать', translation: 'Ёздаҳ', ipa: '/ɐˈdʲinət͡sːətʲ/' },
          { word: 'Двенадцать', translation: 'Дувоздаҳ', ipa: '/dvʲɪˈnat͡sːətʲ/' },
          { word: 'Тринадцать', translation: 'Сездаҳ', ipa: '/trʲɪˈnat͡sːətʲ/' },
          { word: 'Пятнадцать', translation: 'Понздаҳ', ipa: '/pʲɪtˈnat͡sːətʲ/' },
          { word: 'Двадцать', translation: 'Бист', ipa: '/ˈdvat͡sːətʲ/' },
          { word: 'Тридцать', translation: 'Сӣ', ipa: '/ˈtrʲit͡sːətʲ/' },
          { word: 'Сорок', translation: 'Чил', ipa: '/ˈsorək/' },
          { word: 'Пятьдесят', translation: 'Панҷоҳ', ipa: '/pʲɪtʲdʲɪˈsʲat/' },
          { word: 'Сто', translation: 'Сад', ipa: '/sto/' },
        ],
      },
      {
        skillType: 'vocab', title: 'Days of the week', titleTranslated: 'Рӯзҳои ҳафта', emoji: '📅',
        words: [
          { word: 'Понедельник', translation: 'Душанбе', ipa: '/pənʲɪˈdʲelʲnʲɪk/' },
          { word: 'Вторник', translation: 'Сешанбе', ipa: '/ˈftornʲɪk/' },
          { word: 'Среда', translation: 'Чоршанбе', ipa: '/srʲɪˈda/' },
          { word: 'Четверг', translation: 'Панҷшанбе', ipa: '/tɕɪtˈvʲerk/' },
          { word: 'Пятница', translation: 'Ҷумъа', ipa: '/ˈpʲatnʲɪt͡sə/' },
          { word: 'Суббота', translation: 'Шанбе', ipa: '/sʊˈbotə/' },
          { word: 'Воскресенье', translation: 'Якшанбе', ipa: '/vəskrʲɪˈsʲenʲjə/' },
          { word: 'Сегодня', translation: 'Имрӯз', ipa: '/sʲɪˈvodnʲə/' },
          { word: 'Завтра', translation: 'Фардо', ipa: '/ˈzaftrə/' },
        ],
      },
      {
        skillType: 'vocab', title: 'Months', titleTranslated: 'Моҳҳо', emoji: '🗓️',
        words: [
          { word: 'Январь', translation: 'Январ', ipa: '/jɪnˈvarʲ/' },
          { word: 'Февраль', translation: 'Феврал', ipa: '/fʲɪvˈralʲ/' },
          { word: 'Март', translation: 'Март', ipa: '/mart/' },
          { word: 'Апрель', translation: 'Апрел', ipa: '/ɐˈprʲelʲ/' },
          { word: 'Май', translation: 'Май', ipa: '/maj/' },
          { word: 'Июнь', translation: 'Июн', ipa: '/ɪˈjunʲ/' },
          { word: 'Июль', translation: 'Июл', ipa: '/ɪˈjulʲ/' },
          { word: 'Август', translation: 'Август', ipa: '/ˈavɡʊst/' },
          { word: 'Сентябрь', translation: 'Сентябр', ipa: '/sʲɪnˈtʲabrʲ/' },
        ],
      },
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        skillType: 'vocab', title: 'Professions', titleTranslated: 'Касбҳо', emoji: '💼',
        words: [
          { word: 'Врач', translation: 'Духтур', ipa: '/vratɕ/', emoji: '👨‍⚕️' },
          { word: 'Учитель', translation: 'Муаллим', ipa: '/ʊˈtɕitʲɪlʲ/', emoji: '🧑‍🏫' },
          { word: 'Инженер', translation: 'Муҳандис', ipa: '/ɪnʐɨˈnʲer/', emoji: '👷' },
          { word: 'Водитель', translation: 'Ронанда', ipa: '/vɐˈdʲitʲɪlʲ/', emoji: '🚖' },
          { word: 'Повар', translation: 'Ошпаз', ipa: '/ˈpovər/', emoji: '👨‍🍳' },
          { word: 'Продавец', translation: 'Фурӯшанда', ipa: '/prədɐˈvʲet͡s/', emoji: '🧑‍💼' },
          { word: 'Студент', translation: 'Донишҷӯ', ipa: '/stʊˈdʲent/', emoji: '🧑‍🎓' },
          { word: 'Работа', translation: 'Кор', ipa: '/rɐˈbotə/', emoji: '💼' },
        ],
      },
    ...
    lessons: [
      {
        ...
        words: [
          ...
          { word: 'Голубой', translation: 'Осмонранг', ipa: '/ɡəlʊˈboj/', emoji: '🩵' },
          { word: 'Зелёный', translation: 'Сабз', ipa: '/zʲɪˈlʲonɨj/', emoji: '🟢' },
          { word: 'Жёлтый', translation: 'Зард', ipa: '/ˈʐoltɨj/', emoji: '🟡' },
          { word: 'Чёрный', translation: 'Сиёҳ', ipa: '/ˈtɕornɨj/', emoji: '⚫' },
          { word: 'Белый', translation: 'Сафед', ipa: '/ˈbʲelɨj/', emoji: '⚪' },
          { word: 'Оранжевый', translation: 'Норинҷӣ', ipa: '/ɐˈranʐɨvɨj/', emoji: '🟠' },
        ],
      },
      {
        ...
        words: [
          ...
          { word: 'Ручка', translation: 'Қалам (хушкаранг)', ipa: '/ˈrutɕkə/', emoji: '🖊️' },
          ...
          { word: 'Доска', translation: 'Тахта', ipa: '/dɐsˈka/', emoji: '📋' },
          { word: 'Учитель', translation: 'Муаллим', ipa: '/ʊˈtɕitʲɪlʲ/', emoji: '🧑‍🏫' },
          { word: 'Студент', translation: 'Донишҷӯ', ipa: '/stʊˈdʲent/', emoji: '🧑‍🎓' },
        ],
      },
    ...
    lessons: [
      ...
      },
      {
        ...
        words: [
          ...
          { word: 'Банан', translation: 'Банан', ipa: '/bɐˈnan/', emoji: '🍌' },
          { word: 'Виноград', translation: 'Ангур', ipa: '/vʲɪnɐˈɡrat/', emoji: '🍇' },
          { word: 'Дыня', translation: 'Харбуза', ipa: '/ˈdɨnʲə/', emoji: '🍈' },
          { word: 'Вода', translation: 'Об', ipa: '/vɐˈda/', emoji: '💧' },
      ...
      { skillType: 'grammar', grammarKey: 'want', title: 'Хотеть (want)', titleTranslated: 'Феъли «хотеть» — мехоҳам', emoji: '🙏' },
      { skillType: 'grammar', grammarKey: 'accusative', title: 'Accusative case', titleTranslated: 'Падежи винительный', emoji: '🎯' },
    ...
    lessons: [
      {
        ...
        words: [
          ...
          { word: 'Работать', translation: 'Кор кардан', ipa: '/rɐˈbotətʲ/', emoji: '💼' },
          { word: 'Учиться', translation: 'Таҳсил кардан', ipa: '/ʊˈtɕit͡sːə/', emoji: '📚' },
          { word: 'Играть', translation: 'Бозӣ кардан', ipa: '/ɪˈɡratʲ/', emoji: '🎮' },
          { word: 'Спать', translation: 'Хобидан', ipa: '/spatʲ/', emoji: '😴' },
        ],
      },
      { skillType: 'grammar', grammarKey: 'verb_conj', title: 'Verb conjugation (I)', titleTranslated: 'Феълҳои ҳозира (I тип)', emoji: '🔁' },
      { skillType: 'grammar', grammarKey: 'verb_conj2', title: 'Verb conjugation (II)', titleTranslated: 'Феълҳои ҳозира (II тип)', emoji: '🔂' },
      { skillType: 'grammar', grammarKey: 'negation', title: 'Negation with не', titleTranslated: 'Инкор бо «не»', emoji: '🚫' },
      { skillType: 'grammar', grammarKey: 'past_tense', title: 'Past tense', titleTranslated: 'Замони гузашта', emoji: '⏮️' },
      {
    ...
    lessons: [
      {
        ...
        words: [
          { word: 'Школа', translation: 'Мактаб', ipa: '/ˈʂkolə/', emoji: '🏫' },
          { word: 'Больница', translation: 'Беморхона', ipa: '/bɐlʲˈnʲit͡sə/', emoji: '🏥' },
          { word: 'Магазин', translation: 'Мағоза', ipa: '/məɡɐˈzʲin/', emoji: '🏬' },
          { word: 'Банк', translation: 'Бонк', ipa: '/bank/', emoji: '🏦' },
          { word: 'Парк', translation: 'Боғ', ipa: '/park/', emoji: '🌳' },
          { word: 'Рынок', translation: 'Бозор', ipa: '/ˈrɨnək/', emoji: '🛒' },
          { word: 'Станция', translation: 'Истгоҳ', ipa: '/ˈstant͡sɨjə/', emoji: '🚉' },
          { word: 'Улица', translation: 'Кӯча', ipa: '/ˈulʲɪt͡sə/', emoji: '🛣️' },
        ],
      },
    ...
    lessons: [
      {
        ...
        words: [
          { word: 'Плавать', translation: 'Шино кардан', ipa: '/ˈplavətʲ/', emoji: '🏊' },
          { word: 'Петь', translation: 'Сурудан', ipa: '/pʲetʲ/', emoji: '🎤' },
          { word: 'Танцевать', translation: 'Рақсидан', ipa: '/tənt͡sɨˈvatʲ/', emoji: '💃' },
          { word: 'Бегать', translation: 'Давидан', ipa: '/ˈbʲeɡətʲ/', emoji: '🏃' },
          { word: 'Читать', translation: 'Хондан', ipa: '/tɕɪˈtatʲ/', emoji: '📖' },
          { word: 'Писать', translation: 'Навиштан', ipa: '/pʲɪˈsatʲ/', emoji: '✍️' },
          { word: 'Готовить', translation: 'Хӯрок пухтан', ipa: '/ɡɐˈtovʲɪtʲ/', emoji: '🍳' },
          { word: 'Водить машину', translation: 'Ронандагӣ кардан', ipa: '/vɐˈdʲitʲ mɐˈʂɨnʊ/', emoji: '🚗' },
        ],
      },
      ...
      { skillType: 'grammar', grammarKey: 'imperatives', title: 'Imperatives', titleTranslated: 'Феъли амрӣ', emoji: '✋' },
      {
        ...
        words: [
          ...
          { word: 'Горячий', translation: 'Гарм', ipa: '/ɡɐˈrʲatɕɪj/', emoji: '🔥' },
          { word: 'Холодный', translation: 'Хунук', ipa: '/xɐˈlodnɨj/', emoji: '❄️' },
          { word: 'Новый', translation: 'Нав', ipa: '/ˈnovɨj/' },
          { word: 'Старый', translation: 'Кӯҳна', ipa: '/ˈstarɨj/' },
          { word: 'Весёлый', translation: 'Хушҳол', ipa: '/vʲɪˈsʲolɨj/', emoji: '😊' },
          { word: 'Грустный', translation: 'Ғамгин', ipa: '/ˈɡrusnɨj/', emoji: '😢' },
        ],
      },
      {
    ...
    lessons: [
      {
        ...
        words: [
          ...
          { word: 'Солнце', translation: 'Офтоб', ipa: '/ˈsont͡sə/', emoji: '☀️' },
          { word: 'Вода', translation: 'Об', ipa: '/vɐˈda/', emoji: '💧' },
          { word: 'Книга', translation: 'Китоб', ipa: '/ˈknʲiɡə/', emoji: '📕' },
        ],
      },
    ...
    lessons: [
      {
        ...
        words: [
          ...
          { word: 'Цена', translation: 'Нарх', ipa: '/t͡sɨˈna/' },
          { word: 'Дёшево', translation: 'Арзон', ipa: '/ˈdʲoʂɨvə/' },
          { word: 'Дорого', translation: 'Қимат', ipa: '/ˈdorəɡə/' },
          { word: 'Покупать', translation: 'Харидан', ipa: '/pəkʊˈpatʲ/' },
          { word: 'Продавать', translation: 'Фурӯхтан', ipa: '/prədɐˈvatʲ/' },
          { word: 'Рубашка', translation: 'Кӯйлак', ipa: '/rʊˈbaʂkə/', emoji: '👕' },
          { word: 'Обувь', translation: 'Пойафзол', ipa: '/ˈobʊfʲ/', emoji: '👟' },
        ],
      },
