...
try {
  execSync('node prisma/_ko-module-build.mjs ./_ko-m16-content.mjs', { encoding: 'utf8' });
  console.log('Build succeeded on first try!');
} catch (e) {
  ...
  if (missingWords.size > 0) {
    ...
    console.log('No missing words found in output. Might be another error.');
    console.log(output);
  }
}
